...
//     const schemas = [SavedCollectionSchema];
//     const directory = '';
...
//       final objects = <SavedCollection>[
//         SavedCollection(id: 1, name: 'n1', data: 'd1'),
//         SavedCollection(id: 2, name: 'n2', data: 'd2'),
//         SavedCollection(id: 3, name: 'n3', data: 'd3'),
//       ];
...
//       const objId = 1;
//       final testObj = SavedCollection(id: objId, name: '_n', data: '_d');
//       final testObj2 = SavedCollection(id: objId);
...
//       final testObj = SavedCollection(id: 1, name: '_n', data: '_d');
